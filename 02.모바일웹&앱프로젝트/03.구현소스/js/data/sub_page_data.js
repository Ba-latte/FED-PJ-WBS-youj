    ...
    bulgari_eden: {
        ...
        section3: {
            ...
            slide_6: {
                ...
                slide_desc: `고대 지중해를 구성하는 다양한 문화는 서로 충돌하기도 했지만, 이들 간의 차이를 뛰어넘어 모두가 숭배하는 하나의 강력한 상징이 존재했습니다. 바빌론에서 아테네에 이르기까지 세르펜티는 활력, 지혜, 보호의 상징으로 추앙받았습니다. 불가리는 현대에 이르러 세르펜티의 수호자로서 모던한 디자인과 진귀한 젬스톤의 컬러풀한 조합을 통해 세르펜티를 하이 주얼리의 상징으로 다시금 되살리며 계속해서 새로운 변모를 모색합니다.`,
            },
    ...
    roman_high_jeweller: {
        ...
        section3: {
            ...
            slide_2: {
                ...
                slide_desc: `서양 제국은 고대부터 서로 멀리 떨어진 세계 간에 존재하는 차이를 좁히고자 노력해 왔으며, 그 과정에서 발견한 인도와 페르시아 인근 지역의 미학에 감탄을 금치 못했습니다. 수백 년간 실크 로드를 따라 흩뿌려진 씨앗과 마찬가지로, 동양의 개념적인 “꽃” 또한 지중해 지역에서 싹을 틔웠습니다. 불가리가 선보이는 오리엔탈 버즈 네크리스는 지중해 지역의 영감이 피어나는, 상징적인 의미의 정원에 대한 서정적인 비전을 품은 화려한 하이 주얼리 아이템으로 손꼽힙니다.`,
            },
            slide_3: {
                slide_img_src: `./images/sub_page/roman_high_jeweller/mediterranea_bn3.jpg`,
                slide_tit: `메디테라니안 뮤즈 네크리스`,
                slide_desc: `호메로스(Homer)가 활약했던 시대부터 지중해는 전설적인 블루 컬러로, 따사로운 태양빛으로, 눈부시게 반짝이는 섬으로 인간의 상상력을 자극해 왔습니다. 눈부신 지중해 물결을 배경으로 로마 제국이 탄생하였으며, 해안선을 따라 수많은 사람들, 아이디어, 상품이 끊임없이 움직였습니다. 메디테라니안 뮤즈 네크리스는 영감의 원천과도 같은 지중해에 경의를 표합니다. 이곳은 바로 이탈리아 남부 지역의 영혼이자, 눈부신 아름다움과 매혹적인 힘이 시작되는 공간입니다.`,
            },
            slide_4: {
                slide_img_src: `./images/sub_page/roman_high_jeweller/mediterranea_bn4.jpg`,
                slide_tit: `트리뷰트 투 베니스 네크리스`,
                slide_desc: `대운하(Grand Canal) 옆에 자리한, 3개의 기둥으로 구성된 창문 사이로 햇살이 쏟아지고, 멀리서 비발디(Vivaldi)의 사계(The Four Seasons)가 들려오는 듯한 풍경이 담긴 트리뷰트 투 베니스 네크리스는 하나의 꿈, 추억, 따사로운 오후, 베니스에서 즐기는 산책의 순간을 담고 있습니다. 화려한 빛의 향연과 함께 다양한 문화에서 받은 영감을 층층이 담아낸 특별한 주얼리는 베니스의 영혼을 향한 매력적인 찬사와도 같습니다.`,
            },
            slide_5: {
                slide_img_src: `./images/sub_page/roman_high_jeweller/mediterranea_bn5.jpg`,
                slide_tit: `엑세드라 네크리스`,
                slide_desc: `로마와 마찬가지로 장엄하고도 매혹적인 분위기를 선사하는 에메랄드로 시선을 사로잡는 엑세드라 네크리스는 영원의 도시 로마의 건축적 층위를 상징하는 요소에서 영감을 받은, 유서 깊은 쏘뜨와 펜던트입니다. 에세드라 광장(Esedra Piazza)은 고대 로마 최대 규모의 스파였던 디오클레티아누스 황제 스파의 반원형 실외 응접실을 본떠 이름 지어졌습니다. 광장의 중앙에 자리 잡은 19세기 나이아드 분수에서는 고전적인 신화를 향한 찬사와 같은 네 님프를 만나볼 수 있습니다.`,
            },
            slide_6: {
                slide_img_src: `./images/sub_page/roman_high_jeweller/mediterranea_bn6.jpg`,
                slide_tit: `아칸서스 에메랄드 네크리스`,
                slide_desc: `“평화의 제단(Altar of Peace)”이라 불리는 아라 파키스(Ara Pacis)는 로마 최초의 황제인 아우구스투스(Augustus)가 설립한 공간으로, 이곳에는 고대의 가장 탁월한 양각 장식이 자리잡고 있습니다. 정교하게 조각된 아칸서스 플라워 모티브는 파사드 주위에 활력을 더하며 마치 실제로 화이트 컬러의 대리석 꽃잎을 떼어낼 수 있을 것만 같은 느낌을 선사합니다. 아칸서스 에메랄드 네크리스 전체를 아우르는 아치 디자인은 시대를 초월하여 변함없이 사랑받습니다. 기념비적인 아이템으로 손꼽히는 이 네크리스는 역사, 클래식한 장인 기술, 영원한 아름다움이 조화를 이루는 디자인으로 완성되었습니다.`,
            },
        },
    },
}; /////////////////// [ 🔥하이주얼리 메뉴의 서브페이지 데이터🔥 ] /////////////////////////
