                ...
                <section className="section_intro">
                    {
                        ...
                        <article key={i} >
                            <div>
                                <img className='bgimg' src='./images/dt/main/background-right.png' alt='배경이미지' />
                            </div>
                            {/* 1.섹션 아티클 타이틀 */}
                                        ...
                                        <span>
                                            {
                                                ...
                                                <span className="letter" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100" >{v["title"]}</span>
                                            }
                                        </span>
                                    </h2>
                                </div>
